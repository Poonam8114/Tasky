...
export const exportUsersReport = async (req, res, next) => {
  try {
    ...
    //lean method is used to return plain JavaScript objects instead of Mongoose documents, which can improve performance when we only need to read data without using Mongoose's document methods.
